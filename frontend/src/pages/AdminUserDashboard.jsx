...
const AdminUserDashboard = () => {
  ...
  if (error || !targetUser) {
    return (
      <div style={{ minHeight: '100vh', background: '#070b14', color: '#fca5a5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '0.75rem' }}>
        ...
        <button onClick={() => navigate('/admin/dashboard')} style={{ border: '1px solid rgba(79,195,247,0.4)', background: 'transparent', color: '#4fc3f7', padding: '0.5rem 0.9rem', borderRadius: 8, cursor: 'pointer' }}>
  ...
  return <Dashboard readOnly viewAsUser={targetUser} />;
};
